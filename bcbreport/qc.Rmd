...
datatable(qc_table,
  ...
  formatStyle('Average_insert_size',
              backgroundColor = styleInterval(c(mean(qc_table$Average_insert_size) - 
                                                  2 * sd(qc_table$Average_insert_size),
                                                mean(qc_table$Average_insert_size) -
                                                  sd(qc_table$Average_insert_size),
                                                mean(qc_table$Average_insert_size) +
                                                  sd(qc_table$Average_insert_size),
                                                mean(qc_table$Average_insert_size) + 
                                                  2 * sd(qc_table$Average_insert_size)),
